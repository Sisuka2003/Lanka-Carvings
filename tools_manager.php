...
<html>
    ...
    <body>
        ...
        <br/>
        <br/>
                <form method="get" action="tools_manager.php" class="form-a">
        ...
        <table class="tb-user" id="tb-user">
            ...
            <?php
//            $query = "SELECT `id_product`,`product_name`,`product_description`,`product_category`,`sell_price`,`buy_price`,`img_url`,`is_active` FROM `product_tools_equipments`";
//            $result = $connection->query($query);
//            while ($row = $result->fetch_assoc()) {
            $querys = "SELECT * FROM `product_carvings` WHERE `product_name` LIKE '%" . $keyword . "%' AND `category`='tools'";
                ...
                <form>
                    <tr class="data-row">
                        ...
                        <td><a  class="aDelete" href="tools_manager_delete.php?id=<?php echo $row["id_products"]; ?>">DELETE</a></td>
                    </tr>
                </form>
