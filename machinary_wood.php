    ...
    <body>
        <div class="boxBody">
            ...
            <div class="box2-inner-searchbox" align="center">
                <form method="get" action="machinary_wood.php" class="form">
            ...
            <div class="box2">
                <div class="tables">
                    <?php
                    $query = "SELECT * FROM `product_carvings` WHERE `product_name` LIKE '%" . $keyword . "%' AND `category`='machinary' AND `avl_qty`>='1'";
