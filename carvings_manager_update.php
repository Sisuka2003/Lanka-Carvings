...
if ($isSaved) {
      echo "<script> alert('Product Updated successfully');location='carvings_manager.php' </script>";
} else {
      echo "<script> alert('Product Updation failed');location='carvings_manager.php' </script>";
}
