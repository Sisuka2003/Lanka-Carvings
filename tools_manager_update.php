...
if ($isSaved) {
      echo "<script> alert('Product Updated successfully');location='tools_manager.php' </script>";
} else {
      echo "<script> alert('Product Updation failed');location='tools_manager.php' </script>";
}
